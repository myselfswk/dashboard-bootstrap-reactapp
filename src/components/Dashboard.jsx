...
import DeviceA from '../assets/images/device-agnostic.jpg';
import Framework from '../assets/images/Framework.png';
import Html5 from '../assets/images/html5.png';
import UXUI from '../assets/images/UXUI.jpeg';
        ...
        <div className="col main pt-3 mt-3">
            <nav aria-label="breadcrumb">
                <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item"><a href="#nolink">Library</a></li>
            ...
            <div className="row placeholders mb-4">
                <div className="col-6 col-sm-3 placeholder text-center">
                    {/* rounded-circle */}
                    <img src={DeviceA} className="w-100 mx-auto img-fluid" alt="Generic placeholder thumbnail" />
                    <h4>Responsive</h4>
                    <span className="text-muted">Device agnostic</span>
                </div>
                <div className="col-6 col-sm-3 placeholder text-center">
                    <img src={UXUI} className="w-100 mx-auto img-fluid" alt="Generic placeholder thumbnail" />
                    <h4>Frontend</h4>
                    <span className="text-muted">UI / UX oriented</span>
                </div>
                <div className="col-6 col-sm-3 placeholder text-center">
                    <img src={Html5} className="w-100 mx-auto img-fluid" alt="Generic placeholder thumbnail" />
                    <h4>HTML5</h4>
                    <span className="text-muted">Standards-based</span>
                </div>
                <div className="col-6 col-sm-3 placeholder text-center">
                    <img src={Framework} className="w-100 center-block img-fluid" alt="Generic placeholder thumbnail" />
                    <h4>Framework</h4>
            ...
            <div className="card-columns mb-3">
                <div className="card">
                    <img className="card-img-top img-fluid" src={Meter1} alt="Card image cap" />
                    <div className="card-body">
                ...
                <div className="card">
                    <img className="card-img-top img-fluid" src={Meter2} alt="Card image cap" />
                    <div className="card-body">
                ...
                <div className="card">
                    <img className="card-img img-fluid" src={Meter3} alt="Card image" />
                </div>
                        ...
                        <div id="tabsJustifiedContent" className="tab-content">
                            ...
                            <div className="tab-pane active" id="tab2">
                                <div className="row">
                                    ...
                                    <div className="col-sm-5"><img src={Meter1} className="float-right img-responsive img-rounded" /></div>
                                </div>
                                <hr />
                                {/* javascript:; */}
                                <a href="#" className="btn btn-info btn-block">Read More Profiles</a>
